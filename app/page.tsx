        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12">
            ...
            <a
              ...
              aria-label="Journal：経営・運営・ブランディングのデジタル専門誌を読む"
            ...
            >
              <div className="overflow-hidden">
                <img
                  ...
                  alt="昭和レトロな商店街のイラスト、ホテル経営とブランディングのジャーナル"
              ...
              <div className="px-4 pt-3 pb-2 bg-[#f0e2c0] border-b-2 border-[#8A9A7B]">
                <h3 className="text-[#1c1712] text-sm leading-relaxed">経営・運営・ブランディングのデジタル専門誌</h3>
              </div>
            </a>
            ...
            >
              ...
              <div className="px-4 pt-3 pb-2 bg-[#f0e2c0] border-b-2 border-[#8A9A7B]">
                <h3 className="text-[#1c1712] text-sm leading-relaxed">世界から届くジャパントーク</h3>
              </div>
            </a>
            ...
            >
              ...
              <div className="px-4 pt-3 pb-2 bg-[#f0e2c0] border-b-2 border-[#8A9A7B]">
                <h3 className="text-[#1c1712] text-sm leading-relaxed">
                  マーケット分析レポート
                  <span className="block text-xs mt-1 opacity-70">※現在ASEAN&ESG関連レポートを更新中</span>
                </h3>
              </div>
            </a>
          </div>
