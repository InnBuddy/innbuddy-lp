...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const methodSection = document.getElementById('our-method');
      const pricingSection = document.getElementById('pricing');

      if (!hasPassedPortfolio.current) {
  ...
  return (
    <main className="relative w-full overflow-x-hidden">
      <img src="/images/illust/illus_2.jpg" className="fixed bottom-8 left-4 w-36 opacity-70 rotate-[-2deg] z-10 hover:opacity-90 transition-opacity duration-1000 border-0" alt="" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
      <img src="/images/illust/illus_3.jpg" className="fixed right-0 top-0 w-72 opacity-[0.06] z-0 border-0" alt="" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />

      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/images/fog_forest.png" className="w-full h-full object-cover animate-kenburns border-0" alt="" />
      ...
      <section className="py-16 md:py-32 bg-background">
        <div className="max-w-6xl mx-auto px-4 md:px-6 space-y-16 md:space-y-32">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="relative h-64 md:h-96"><img src="/images/forest_stream.png" className="w-full h-full object-cover border-0" alt="" /></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="order-1 md:order-2 relative h-64 md:h-96"><img src="/images/food_kaiseki.png" className="w-full h-full object-cover border-0" alt="" /></div>
          </div>
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="relative h-64 md:h-96"><img src="/images/craftsman_hands.png" className="w-full h-full object-cover border-0" alt="" /></div>
            <div className="max-w-full md:max-w-md mx-auto md:mx-0">
      ...
      <section className="py-16 md:py-24 bg-background"><p className="text-center text-xs tracking-[0.2em] text-accent-rust mb-8 md:mb-16">資産の解像度</p><div className="max-w-6xl mx-auto px-4 md:px-6 grid grid-cols-2 gap-4 md:gap-6"><div className="space-y-4 md:space-y-6"><div className="h-48 md:h-64 w-full"><img src="/images/detail_steam.png" className="w-full h-full object-cover border-0" alt="" /></div><div className="h-56 md:h-80 w-full"><img src="/images/detail_wood.png" className="w-full h-full object-cover border-0" alt="" /></div><div className="h-48 md:h-72 w-full"><img src="/images/detail_light.png" className="w-full h-full object-cover border-0" alt="" /></div></div><div className="space-y-4 md:space-y-6 mt-12 md:mt-24"><div className="h-48 md:h-72 w-full"><img src="/images/detail_hand.png" className="w-full h-full object-cover border-0" alt="" /></div><div className="h-48 md:h-64 w-full"><img src="/images/detail_water.png" className="w-full h-full object-cover border-0" alt="" /></div><div className="h-56 md:h-80 w-full"><img src="/images/detail_stone.png" className="w-full h-full object-cover border-0" alt="" /></div></div></div></section>

      <section className="py-12 md:py-16 bg-background">
        <div className="max-w-5xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <img src="/images/breath_1.jpg" className="h-48 md:h-64 w-full object-cover border-0" alt="" />
            <img src="/images/breath_2.jpg" className="h-48 md:h-64 w-full object-cover border-0" alt="" />
            <img src="/images/breath_3.jpg" className="h-48 md:h-64 w-full object-cover border-0" alt="" />
          </div>
          ...
          <div className="flex space-x-4 md:space-x-8">
            {[
              ...
              <div key={i} className="flex-shrink-0 w-[280px] md:w-[350px] group">
                <img src={item.img} alt={item.caption} className="h-64 md:h-96 w-full object-cover transition-transform duration-1000 group-hover:scale-[0.98] border-0" />
      ...
      <section className="py-16 md:py-24 bg-background border-t border-hairline">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-6 md:space-y-8">
            {[
              { 
                q: "OTA運用代行とは具体的にどのようなサービスですか？", 
                a: "OTA運用代行とは、楽天トラベル・じゃらん・Booking.com・Agodaなどのオンライン旅行予約サイトの運用を専門家が代行するサービスです。販売戦略の立案、価格調整、在庫管理、ページ改善、口コミ対応、サイトコントローラー操作などを一括で行い、宿泊施設の予約獲得を最大化します。" 
              },
              { 
                q: "1ヶ月無料トライアルの内容を教えてください。", 
                a: "1ヶ月無料トライアルでは、OTA運用代行の基本サービスを無料でご利用いただけます。期間中は、販売戦略のご提案、価格調整、OTAページの改善などを提供いたします。翌月以降の契約義務はなく、1ヶ月のみのご利用も可能です。具体的なご要望がございましたら、お問い合わせフォームよりお送りください。\n\nまた、中長期的に安定した売上・運用・経営の最適化をお考えの企業様には、初月に初期設定を済ませ、その後も継続的にご支援できるよう、OTA領域に限らず順次最善の提案をいたします。\nまずは無料診断をお受けいただき、結果を送信ください（売上診断・採用診断のどちらも無料でご利用いただけます）。" 
              },
              { 
                q: "海外OTAの運用も可能ですか？", 
                a: "はい、Booking.com・Agoda・Trip.com・Traveloka・Expediaなど、主要な海外OTA全てに対応しています。英語・中国語・ASEAN圏の言語にも対応し、インバウンド集客を強力に支援します。" 
              },
              { 
                q: "どのような規模の宿泊施設が対象ですか？", 
                a: "5室〜100室規模のホテル、旅館、民宿など、幅広い宿泊施設に対応しています。特に、OTA運用に時間や専門知識が不足しがちな中小規模の宿泊施設にご利用いただきやすいよう設計しております。" 
              },
              { 
                q: "インバウンド対策とは具体的にどんな取り組みですか？", 
                a: "海外向けOTAページの作成・見直し、販売戦略の立案に加え、ハラール対応（ムスリムフレンドリー）やESG対応の視点も取り入れてまいります。独自の海外ネットワークを活用し、現地のリアルな声を施策に取り入れてまいります。" 
              },
              { 
                q: "サイトコントローラーの導入支援も行っていますか？", 
                a: "はい、サイトコントローラーの選定から導入、運用までトータルサポートしています。複数OTAの在庫・価格を一元管理し、ダブルブッキング防止と業務効率化を実現します。" 
              },
              { 
                q: "成果報酬型のプランはありますか？", 
                a: "2ヶ月目以降は、予約獲得数や売上向上に連動した成果報酬型プランをご用意しております。具体的な報酬体系は、無料相談時に施設の現状を踏まえてご案内いたします。" 
              },
              { 
                q: "他社との違いはなんですか？", 
                a: "日本最大級のOTA企業や大手人材企業、海外法人の経営メンバー経験者などで構成されたチームが、アイデアを出し合いながら貴社を担当いたします。そのため、専任担当者によるOTA運用代行にとどまらず、財務を意識した経営強化を最大の目標として支援いたします。\n\nまた、弊社はサステナブル経営を重視しており、利益追求と同時に従業員満足度の向上を図り、地域のシンボルとなるようなデスティネーションデザインをご提供しております。" 
              },
            ].map((faq, i) => (
              <details key={i} className="group border-b border-hairline pb-6">
                ...
                <p className="mt-4 text-sm text-foreground/60 leading-relaxed whitespace-pre-line">{faq.a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-32 bg-background text-center border-t border-hairline relative overflow-hidden"><img src="/images/illust/illus_1.jpg" className="absolute top-0 left-1/2 -translate-x-1/2 w-96 opacity-20 rotate-[-2deg] z-0 border-0" alt="" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} /><div className="relative z-10 max-w-2xl mx-auto px-4 md:px-6"><h2 className="font-serif font-light text-3xl md:text-4xl text-foreground mb-8">まずは、あなたの宿の「眠れる資産」を教えてください。</h2><p className="text-sm text-foreground/60 mb-12 leading-relaxed">私たちが最初にやることは、無料であなたの宿の可能性を診断することです。リスクはゼロ。そこから、あなたと共に次の一歩を考えます。</p><a href="https://timerex.net/s/InnBuddy_ESG/386fd946" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#ABBAA9] text-black font-['Zen_Old_Mincho'] px-10 py-4 text-sm tracking-widest hover:bg-[#B4BC4E] hover:text-white transition-colors duration-700">お話を聞かせてください</a></div></section>

      <section className="py-12 md:py-16 bg-background">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <img src="/images/breath_4.jpg" className="h-36 md:h-48 w-full object-cover border-0" alt="" />
            <img src="/images/breath_5.jpg" className="h-36 md:h-48 w-full object-cover border-0" alt="" />
            <img src="/images/breath_6.jpg" className="h-36 md:h-48 w-full object-cover border-0" alt="" />
            <img src="/images/breath_7.jpg" className="h-36 md:h-48 w-full object-cover border-0" alt="" />
            <img src="/images/breath_8.jpg" className="h-36 md:h-48 w-full object-cover border-0" alt="" />
          </div>
      ...
      <section id="pricing" ref={pricingSectionRef} className="py-16 md:py-24 bg-background">
      ...
      <section className="relative py-32 md:py-48 bg-background">
        <div className="absolute inset-0 z-0">
          <img src="/images/fog_forest_dawn.png" className="w-full h-full object-cover opacity-90 animate-kenburns border-0" alt="" />
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12">
            ...
            <Link
              ...
              aria-label="Journal：ホテル運営/ブランディングのデジタル専門誌を読む"
              className="group block rounded-[4px] border-2 border-[#E8B93C] bg-[#1c1712] hover:scale-[1.02] transition-transform duration-300 ease-out relative overflow-hidden"
            >
              <div className="overflow-hidden">
                <img
                  src="/images/library/journal_landscape.png"
                  alt="昭和レトロな商店街のイラスト、ホテル運営/ブランディングのジャーナル"
              ...
              <div className="px-4 pt-3 pb-2 bg-[#1c1712] border-b-2 border-[#8A9A7B]">
                <h3 className="text-white text-sm leading-relaxed">ホテル運営/ブランディングのデジタル専門誌</h3>
              </div>
            </Link>
            ...
            <Link
              href="/library/story"
              aria-label="Story：世界の旅行者が語る日本体験ストーリーを読む"
              className="group block rounded-[4px] border-2 border-[#E8B93C] bg-[#1c1712] hover:scale-[1.02] transition-transform duration-300 ease-out relative overflow-hidden"
            >
              <div className="overflow-hidden">
                <img
                  src="/images/library/story_landscape.png"
                  alt="歌舞伎役者と武将のイラスト、世界の旅行者が語る日本体験ストーリー"
                  className="w-full aspect-video object-cover transition-transform duration-500 group-hover:scale-105 border-0"
                />
              </div>
              <div className="absolute inset-0 bg-[#8A9A7B]/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="px-4 pt-3 pb-2 bg-[#1c1712] border-b-2 border-[#8A9A7B]">
                <h3 className="text-white text-sm leading-relaxed">世界から届くジャパントーク</h3>
              </div>
            </Link>

            {/* Analysis */}
            <Link
              href="/library/analysis"
              aria-label="Analysis：マーケット分析レポートを見る"
              className="group block rounded-[4px] border-2 border-[#E8B93C] bg-[#1c1712] hover:scale-[1.02] transition-transform duration-300 ease-out relative overflow-hidden"
            >
              <div className="overflow-hidden">
                <img
                  src="/images/library/analysis_landscape.png"
                  alt="森と分析グラフのイラスト、インバウンド市場の分析レポート"
                  className="w-full aspect-video object-cover transition-transform duration-500 group-hover:scale-105 border-0"
                />
              </div>
              <div className="absolute inset-0 bg-[#8A9A7B]/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="px-4 pt-3 pb-2 bg-[#1c1712] border-b-2 border-[#8A9A7B]">
                <h3 className="text-white text-sm leading-relaxed">マーケット分析レポート</h3>
                <div className="border-b-2 border-[#8A9A7B] my-2 -mx-4" />
                <p className="text-white text-xs opacity-80">※現在ASEAN&ESG関連レポートを更新中</p>
              </div>
            </Link>
          </div>
        </div>
